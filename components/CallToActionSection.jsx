  ...
  return (
    <div className="relative">
      ...
      >
        ...
        >
          ...
          <div className="flex space-x-4 justify-center">
            <button
              className="bg-[#2E3192] hover:bg-blue-800 text-white px-6 py-3 rounded-md text-base font-bold transition-colors"
      ...
      <div className="absolute left-1/2 bottom-0 translate-x-[-50%] translate-y-1/2 flex flex-col md:flex-row gap-6 md:gap-12 z-10">
        <button
          className="flex items-center justify-center gap-2 px-10 py-6 rounded-xl shadow-md transition hover:shadow-lg hover:-translate-y-1 bg-[#EFEFF7] hover:bg-[#2E3192] group"
