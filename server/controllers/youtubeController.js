...
//     // Get videos from uploads playlist (limit 50)
...
//         tags: [], // Optional: parse tags if needed
//         category: snippet.categoryId || '',
//         language: '', // Optional: extract if needed
//         metrics: {
...
//     res.json({
//       success: true,
//       message: `${imported} YouTube videos imported successfully.`
//     });
//   } catch (error) {
...
//       // Get video details including stats and contentDetails for duration
//       const videoRes = await axios.get(`${baseUrl}/videos`, {
//         params: {
//           part: 'snippet,statistics,contentDetails',
//           id: videoId,
...
//       // Only import videos with duration <= 180 seconds (3 minutes)
